        ...
        topBar = {
            CenterAlignedTopAppBar(
                ...
                colors = TopAppBarDefaults.centerAlignedTopAppBarColors(
                    containerColor = Color(0xFFFFC0CB) // Rosa claro para la barra
                )
            )
        }
    ) { paddingValues ->
        Column(
            ...
            OutlinedTextField(
                ...
                colors = TextFieldDefaults.outlinedTextFieldColors(
                    focusedBorderColor = Color(0xFFFFC0CB), // Rosa claro para el borde enfocado
                    unfocusedBorderColor = Color(0xFFFFC0CB), // Rosa claro para el borde no enfocado
                    focusedLabelColor = Color(0xFFFFC0CB) // Rosa claro para la etiqueta enfocada
                )
            )
            ...
            Row(
                ...
                Button(
                    ...
                    colors = ButtonDefaults.buttonColors(containerColor = Color(0xFFFFC0CB)) // Rosa claro para los botones
                ) {
