        ...
        topBar = {
            CenterAlignedTopAppBar(
                ...
                colors = TopAppBarDefaults.centerAlignedTopAppBarColors(
                    containerColor = Color(0xFFFFC0CB) // Rosa claro
                )
            )
        }
    ) { paddingValues ->
        Column(
            ...
            OutlinedTextField(
                ...
                colors = TextFieldDefaults.outlinedTextFieldColors(
                    focusedBorderColor = Color(0xFFFFC0CB), // Rosa claro
                    unfocusedBorderColor = Color(0xFFFFC0CB), // Rosa claro
                    focusedLabelColor = Color(0xFFFFC0CB) // Rosa claro
                )
            )
            ...
            Button(
                ...
                modifier = Modifier.fillMaxWidth(),
                colors = ButtonDefaults.buttonColors(containerColor = Color(0xFFFFC0CB)) // Rosa claro para el botón
            ) {
