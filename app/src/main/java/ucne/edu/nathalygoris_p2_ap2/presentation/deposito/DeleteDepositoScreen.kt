    ...
    Scaffold(
        ...
        Column(
            ...
            Row(
                ...
                Button(
                    onClick = goBack,
                    colors = ButtonDefaults.buttonColors(containerColor = Color(0xFFD3D3D3)) // Gris claro
                ) {
                    Text(text = "Cancelar")
                }
                ...
                Button(
                    ...
                    colors = ButtonDefaults.buttonColors(containerColor = Color(0xFFFFC0CB)) // Rosa claro
                ) {
